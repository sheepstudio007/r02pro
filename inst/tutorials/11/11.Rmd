...
1. Write R codes using global mapping that generates the following graph.(Tip: Different smoothline fits depend on the value of variable `drv`)
...
2. Write R codes using global mapping that generates to generate the following graph.
