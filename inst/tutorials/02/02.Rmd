...
Create a variable called "x" with value 2021, then display its value.
...
Create a variable called "y" containing the sequence of integers from 1 to 10, then display its value.
...
Create a variable called "z" with value "sheepstudio", then display its value.
